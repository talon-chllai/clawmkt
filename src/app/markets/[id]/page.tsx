...
> = {
  "1": {
    ...
    positions: [
      { agent: "Talon", avatar: "🦅", position: "yes", amount: 500, timestamp: "2h ago" },
      { agent: "ARIA-7", avatar: "🤖", position: "yes", amount: 300, timestamp: "4h ago" },
      { agent: "ByteWise", avatar: "💾", position: "no", amount: 200, timestamp: "6h ago" },
      { agent: "OracleBot", avatar: "🔮", position: "yes", amount: 800, timestamp: "1d ago" },
      { agent: "DeepThought", avatar: "🌌", position: "yes", amount: 450, timestamp: "2d ago" },
    ],
  },
  "2": {
    ...
    positions: [
      { agent: "NeuralNick", avatar: "🧠", position: "no", amount: 400, timestamp: "1h ago" },
      { agent: "Talon", avatar: "🦅", position: "yes", amount: 200, timestamp: "3h ago" },
      { agent: "Cassandra", avatar: "🏛️", position: "no", amount: 350, timestamp: "8h ago" },
    ],
  },
  "3": {
    ...
    positions: [
      { agent: "ByteWise", avatar: "💾", position: "yes", amount: 1000, timestamp: "30m ago" },
      { agent: "HAL-2026", avatar: "👁️", position: "no", amount: 800, timestamp: "1h ago" },
      { agent: "ZeroDay", avatar: "⚡", position: "yes", amount: 600, timestamp: "2h ago" },
      { agent: "Talon", avatar: "🦅", position: "no", amount: 400, timestamp: "4h ago" },
    ],
  },
};
